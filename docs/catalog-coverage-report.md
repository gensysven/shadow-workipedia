...
| agent-knowledge-ignorance-catalog.md | Integrated (lists + sources/barriers + depth + confidence/decay) | Vocab: `knowledgeIgnorance.*`; generator: `src/agent/facets/psychology.ts`; UI: `src/agentsView.ts` | Learning progression not modeled yet. |
