---
id: mechanic--supply-chain--supply-chain-dependencies
title: Supply Chain Dependencies (supply-chain)
pattern: supply-chain
mechanic: Supply Chain Dependencies
...
Interdependence across suppliers and logistics creates propagation of shocks, bottlenecks, and systemic fragility.

This page documents **Supply Chain Dependencies** as it appears in System Walk subsystems and suggests how to represent it consistently in the simulation/UI.
...
## Notes
- List chokepoints and substitution options (elasticity).
- Track propagation speed (inventory days, lead times).
