---
id: mechanic--severity-level--severity-levels
title: Severity levels (severity-level)
pattern: severity level
mechanic: severity levels
...
This page documents **Severity levels** as it appears in System Walk subsystems and suggests how to represent it consistently in the simulation/UI.
