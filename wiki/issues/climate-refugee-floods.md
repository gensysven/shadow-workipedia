...
1. **Island Nation Evacuation**: Triggered when sea level rise exceeds 1.5m + storm surge events make inhabited land uninhabitable. Affects 11 million people in Pacific and Indian Ocean island nations. Evacuation unfolds over 5-10 years with negotiations for resettlement treaties. Tuvalu (11,000 people) negotiates relocation to Australia/New Zealand; Kiribati (120,000) faces complete absorption by neighboring nations. Each evacuation costs $50,000-150,000 per person for relocation, legal status, and integration support. Failed negotiations leave populations stateless.

2. **Mass Coastal Displacement**: Triggered by Category 5+ storms, 1-in-100-year flood events, or catastrophic infrastructure failure in coastal megacities. Jakarta (10 million), Lagos (15 million), Dhaka (22 million), and Miami (6 million) face existential risk. A single event displaces 1-5 million over weeks. Regional variation: Asian megacities lack relocation infrastructure (95% displaced remain within 100km, overwhelming regional capacity); Western cities have evacuation plans but inadequate permanent housing (40% become long-term displaced). Each event triggers insurance industry collapse in affected region (-$100B+ in claims).

3. **Refugee Camp Explosion**: Triggered when camp population exceeds 200% design capacity + resource shortfalls (water below 15L/person/day, food below 2,100 kcal/day). Probability scales with duration: 5% per year at 150% capacity, 25% per year at 300% capacity. Outcomes include: cholera outbreaks (mortality 5-15%), inter-ethnic violence (100-1,000 deaths), mass breakouts (refugees disperse into host country, triggering crackdowns), or host government forcibly closes camp (displacing residents, collapsing regional humanitarian cooperation -40%).

4. **Maritime Interdiction Crisis**: Triggered when maritime migration routes exceed 10,000 crossings/month + receiving nation implements zero-tolerance policy. Mediterranean route (Libya to Italy) and Bay of Bengal route (Myanmar to Indonesia) most volatile. Coast guards face operational dilemma: enforce borders (increasing death toll by +300% as smugglers use riskier routes) or conduct rescues (creating pull factor that increases crossings +50%). Each crisis generates 2,000-5,000 deaths/year and imposes -25% penalty to international humanitarian cooperation.

5. **Climate Asylum Precedent**: Triggered by high-profile court case where climate migrant seeks refugee status under expanded interpretation. Success probability: 15% in European courts, 8% in US, 35% in New Zealand/Pacific nations. Positive precedent opens floodgates: legal recognition increases applications by +400% over 2 years, granting refugee status to estimated 5-15 million. Negative precedent forecloses legal pathway, increasing irregular migration +60% and smuggling industry revenue +$12B/year. Regional variation: Pacific nations recognize climate refugees first (2025-2030), Europe fragments (Nordic states accept, Eastern Europe rejects), US refuses recognition until 2040+.
