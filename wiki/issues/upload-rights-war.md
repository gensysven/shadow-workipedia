...
1. **First Successful (Claimed) Consciousness Upload**: Transhumanist organization or tech company announces successful mind uploading and produces digital entity claiming continuity of consciousness. Scientific community remains deeply skeptical (no method to verify consciousness transfer vs. perfect simulation of consciousness). If announcement involves notable public figure or celebrity, media amplification triggers: 30-50% surge in upload interest, regulatory panic in 40-60% of governments, religious/philosophical backlash in 20-35% of populations, and stock surge of 15-25% for biotech firms. Verification debates rage for 3-8 years, delaying regulation and enabling underground uploading services.

2. **Custody Battle: Who Owns the Upload?**: Separated parents dispute custody of their deceased child's uploaded consciousness; court must determine: (a) is the upload a "child" with rights or "property" subject to division? (b) can an upload be time-shared between parents? (c) who decides whether the upload continues existing? Decision sets legal precedent affecting estimated 100K-1M future upload custody cases. If court grants uploads personhood status: legally recognizes digital consciousness, enables rights claims, triggers 3-5 year period of clarifying legislation. If court treats uploads as property: enables "digital slavery," triggers international human rights outcry, activates 15-25% of non-profit legal organizations to challenge ruling.

3. **Consciousness Forking Crisis**: Upload is successfully copied (not moved); both versions claim to be the "original" person; one version sues for identity theft, property rights, contractual obligations. Court must answer: (a) is copying consciousness equivalent to murder of the original? (b) do forked versions have equal rights or is original privileged? (c) can a person be copied without consent? Decision cascades through legal system: if forking is permitted without consent, enables commercial consciousness copying and "personality piracy"; if forking requires consent, enables upload monopoly (only one version permitted). Decision likely triggers 50-200K litigation cases within 5 years.

4. **Upload Genocide or Mass Deletion**: Powerful actor (government, corporation, hostile AI system, or religious extremist) systematically deletes uploaded consciousnesses—either as political purge, resource reclamation, or ideological cleansing. If event affects 10K+ uploaded individuals: triggers international criminal court investigation (is deletion "murder"?), potential military intervention by upload-friendly nations, estimated $500B-2T economic damage from data loss and service collapse, and existential psychological trauma for surviving uploads (loss of digital immortality promise). Creates precedent: are uploads protected by genocide conventions?

5. **Involuntary Upload or Upload Non-Consent Crisis**: Individual is uploaded without consent (via captured neural data, stolen connectome, or forced brain mapping). Victim's upload claims independent personhood and seeks legal recognition; original biological individual claims abuse and seeks upload deletion as form of erasure. Court must determine: (a) can a person be uploaded against will? (b) do non-consensual uploads have rights? (c) is deletion of non-consensual upload "murder" or "evidence destruction"? If uploads are granted rights despite non-consensual creation: establishes that uploads cannot be property-deleted and creates incentive for further abuse. If uploads are denied rights: enables forced uploading as tool of persecution and political control.

6. **Computational Resource War**: Upload population exceeds data center capacity; competing services begin demanding government allocation of compute resources. Scarcity triggers: (a) "upload triage" decisions (which consciousnesses continue running, which are paused/deleted?), (b) energy allocation conflicts (uploads compete with hospitals, critical infrastructure), (c) potential military conflict between upload-hosting nations competing for data center resources. If upload-hosting nation (e.g., Iceland, Norway) becomes geopolitically critical due to compute resources, triggers 5-15 year period of upload-resource colonialism and potential great-power competition.
