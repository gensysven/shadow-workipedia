...
**Event Types:**
1. **Automated Eviction Surge**: Landlord platforms file bulk evictions when housing market conditions trigger—rent increases above local median by 15%, or vacancy rates drop below 3.5%. Single event affects 300-800 tenants simultaneously. Tenants receive algorithmically generated 3-day notices with standardized language that omits jurisdiction-specific tenant rights. Success rate for tenants: 8% when facing bulk filings versus 31% for individual cases

2. **Algorithmic Judge Trial**: Court deploys automated decision-making for routine eviction cases flagged as "non-contested" by document scanning AI. System reduces tenant win rates by 45% compared to human judges. Algorithmic judge assigns 92% weight to landlord testimony presented via affidavit, 8% weight to tenant verbal testimony. If tenant misses virtual hearing by 5+ minutes due to technical issues, automated system issues default judgment with no opportunity to reschedule

3. **Blacklist Notification**: Tenant appears on AI screening platform after eviction filing (not conviction). Rental application rejection rate increases from 23% to 89% overnight. Blacklist persists for 7-10 years depending on state law, but algorithmic screeners retain data indefinitely due to "legitimate business interest" exemptions. Tenant has no notification blacklist exists until third rental rejection. Formal dispute process takes 90-120 days, during which tenant cannot rent

4. **Debt Escalation**: Collection algorithm adds late fees ($75-150/month), court costs ($350-800), interest (18-24% APR), and attorney fees ($1,200-2,400), causing debt to snowball 2.3-3.7x original amount. Original $1,400 rent debt becomes $4,800 judgment within 6 months. Automated wage garnishment filing triggers within 30 days of judgment, claiming 25% of gross wages. Tenants earning $2,400/month lose $600/month to garnishment, making future rent payments impossible

5. **Legal Aid Crisis**: Eviction filings increase 28% year-over-year while legal aid funding remains flat. Public defender offices face 4,200 cases per attorney (versus 150 cases recommended by ABA standards). Too many filings, too few lawyers; offices implement triage systems that only represent tenants facing homelessness with children. 71% of eligible tenants receive "brief advice" phone calls instead of representation. Emergency motions filed by pro se tenants get denied at 94% rate due to procedural errors algorithmic systems exploit
