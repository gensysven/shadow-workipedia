...
1. **Mass Shooting Incident**: High-casualty event (4+ killed) that triggers: public outrage, media saturation, demand for regulation increase. Immediate effects: public polling shows 70-85% support for specific safety measures; gun control advocates mobilize; absolutists frame as "shouldn't restrict rights of 330 million due to tragedy." Cascade trigger: if >5 mass shootings within 12 months, or >40 total deaths in high-profile incidents, public demand reaches critical levels (85%+ support for regulation). Government response depends on political context: with compromise capacity >40%, likely some regulatory response; with compromise capacity <25%, likely legislative paralysis despite public demand. Result: unmet public expectation → trust decline (-15-25%), political polarization surge (+5-10 points).

2. **Court Strikes Down Regulation**: Major court decision (state or federal) invalidates existing firearms safety regulation on Second Amendment grounds. Triggers: regulatory paralysis increase (+10-15%), legal uncertainty for future regulations (+20-30% increase in litigation costs for regulatory efforts), absolutist political confidence increase (+10 points on absolutism index), public sense that courts block safety (public trust decline -10-15%). If multiple regulations struck down within 12-month period (cascade trigger): regulatory capacity becomes severely compromised; government loses legal tools for policy response; public frustration with courts increases; potential for institutional conflict between legislative branch (wanting to regulate) and judicial branch (blocking regulation).

3. **Compromise Legislative Success**: Rare event in which Democrats and Republicans agree on modest safety measure (e.g., background check expansion, crisis intervention protocols). Triggers: regulatory paralysis decline (-10-15%), public trust increase (+5-10%), political polarization decline (-2-3 points), momentum for additional measures. Cascade trigger: if multiple compromise measures pass within 24 months, potential for institutional learning where compromise becomes normalized (compromise capacity increase +15-20%). Difficult event to trigger in high-polarization environment (requires legislative opportunity + moderate voices in both parties).

4. **Constitutional Crisis — Judicial vs. Legislative**: Fundamental conflict emerges between courts (striking down regulations) and legislature (passing regulations). Triggers: institutional conflict increase, public trust in government decline (-20-30% as institutions appear in conflict), separation-of-powers questions raised, potential for court-packing proposals (expansion of justices, nomination warfare). If unresolved for 12+ months: fundamental governance question unresolved: can democratic majorities regulate firearms, or do courts block all regulation? Constitutional crisis becomes salient public issue.

5. **Militia/Extremist Violence**: Armed group explicitly motivated by gun rights absolutism engages in violence (attack on law enforcement, armed standoff, violent confrontation). Triggers: public safety concern increase (+15-25%), regulatory support increase (8-10 points), polarization surge (+10-15%), militia recruitment increase (+20-30% following incident), potential for retaliatory violence. Cascade trigger: if 2+ such incidents within 12 months, militia movement can spiral into sustained violent conflict; government response options limited (enforcement can provoke further militia response).

6. **Firearms Density Surge**: Rapid increase in civilian firearm ownership (e.g., following mass shooting media coverage, political polarization spike, regulatory threat). USA already has ~120 firearms per 100 civilians (highest globally). Further density increase correlates with: mass shooting frequency increase (+1.5-2.0x for each 20-point density increase), suicide rate increase (+10-15% per 20-point density increase), accidental death rate increase (+20-30%), unintended discharge risk (higher density = higher probability of accidents). Very high density (>150 per 100) creates technical impossibility of effective confiscation + increases likelihood of defensive gun violence (private citizens using guns against perceived threats, often with insufficient information).

7. **Public Safety Crisis Threshold**: Perceived crisis around gun violence reaches unsustainable levels (100+ mass shooting deaths in single year + suicide rate spike + violent crime linked to firearm access). Triggers: public demand for extreme regulatory measures (80%+ support for restrictions), absolutist resistance mobilization, potential for extreme policy responses from frustration (e.g., confiscation proposals that trigger armed resistance), institutional legitimacy questions. If crisis sustained for 12+ months without meaningful policy response: potential for vigilante safety measures, private security expansion, social fragmentation (armed vs. non-armed communities).
